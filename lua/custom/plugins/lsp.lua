  ...
  config = function()
    ...
    vim.api.nvim_create_autocmd('LspAttach', {
      ...
      callback = function(event)
        ...
        map(';rf', require('telescope.builtin').lsp_references, 'Goto [R]e[f]erences')
        ...
        map(';H', vim.lsp.buf.signature_help, 'Signature [H] Documentation', 'i')
        map(';o', vim.diagnostic.open_float, '[O]pen Diagnostic')
        map(';[', prevDiadnosticAction, 'Prev Diagnostic + Code Action')
        map(';]', nextDiadnosticAction, 'Next Diagnostic + Code Action')

        -- Jump to the implementation of the word under your cursor.
        --  Useful when your language has ways of declaring types without an actual implementation.
        map(';i', require('telescope.builtin').lsp_implementations, 'Goto [I]mplementation')

        -- Jump to the definition of the word under your cursor.
        --  This is where a variable was first declared, or where a function is defined, etc.
        --  To jump back, press <C-t>.
        map(';d', require('telescope.builtin').lsp_definitions, 'Goto [D]efinition')

        -- WARN: This is not Goto Definition, this is Goto Declaration.
        --  For example, in C this would take you to the header.
        map(';D', vim.lsp.buf.declaration, 'Goto [D]eclaration')
        ...
        map(';t', require('telescope.builtin').lsp_type_definitions, 'Goto [T]ype Definition')
